...
Original command source: `sources/claude-code-plugins/rpi/commands/create_plan.md`

Environment adaptation note:
- When the text says `Read tool`, read files fully with local shell tools
- When the text says `TodoWrite`, track the work with the current environment's plan/task mechanism
- When the text says `Task agents` or named agents, use `spawn_agent` when available, otherwise perform the research locally

---

Create implementation plans with thorough research.
...
5. **Track Progress**:
   - Track planning tasks as you complete research
   - Mark planning tasks complete when done

6. **No Open Questions in Final Plan**:
   - Resolve or explicitly bound uncertainties before finalizing the plan
